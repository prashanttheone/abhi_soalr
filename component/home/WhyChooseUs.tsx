        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-green-600 font-semibold text-sm tracking-wider uppercase">
              Why Choose BRL RENEWABLE ENERGIES PVT LTD
            </span>
            <div className="h-1 w-12 bg-gradient-to-r from-blue-600 to-green-500" />
          </div>
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            The <span className="bg-gradient-to-r from-green-500 to-blue-600 bg-clip-text text-transparent">BRL RENEWABLE ENERGIES PVT LTD Difference</span>
          </h2>

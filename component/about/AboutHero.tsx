        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              Since 2015, BRL RENEWABLE ENERGIES PVT LTD has been at the forefront of solar energy revolution, transforming homes and businesses across the India. We believe in clean energy, sustainable growth, and customer excellence.
            </p>
